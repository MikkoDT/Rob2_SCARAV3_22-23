...
def f_k():
    ...
    # joint variables: cm if f, degrees if theta
    ...
    PT = [[float(T1),(90.0/180.0)*np.pi,0,float(a1)],
    ...
    # Create Links
    # [robot_variable]=DHRobot([RevoluteDH(d,r,alpha,offset)]),PrismaticDH(theta,r,alpha,offset)
    SPHERICALV3 = DHRobot([
        RevoluteDH(a1,0,(90/180.0)*np.pi,0,qlim=[(-90/180)*np.pi,(90/180)*np.pi]),
        RevoluteDH(0,a2,(0.0/180.0)*np.pi,(90/180.0)*np.pi,qlim=[(-90/180)*np.pi,(90/180)*np.pi]),
        PrismaticDH(0,0,0,a3,qlim=[0,0]),
    ], name="SPHERICALV3" )

    #plot joints
    q1 = np.array([d3,T1,T2])
...
def i_k():
    ...
    # [robot_variable]=DHRobot([RevoluteDH(d,r,alpha,offset)]),PrismaticDH(theta,r,alpha,offset)
    SPHERICALV3 = DHRobot([
        RevoluteDH(a1/100,0,(90/180.0)*np.pi,0,qlim=[(-90/180)*np.pi,(90/180)*np.pi]),
        RevoluteDH(0,a2/100,(0.0/180.0)*np.pi,(90/180.0)*np.pi,qlim=[(-90/180)*np.pi,(90/180)*np.pi]),
        PrismaticDH(0,0,0,a3/100,qlim=[0,0]),
    ], name="SPHERICALV3" )

    #plot joints
    q1 = np.array([D3/100,Th1,Th2])
...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables",font=(5),bg="black",fg="cyan")
FI.grid(row=0,column=0)

#Link lengths label
a1 = Label(FI,text=("a1 = "),font=(10),bg="violet")
a1_E = Entry(FI,width=5,font=(10),fg="black")
cm1 = Label(FI,text=("cm "),font=(10))

a2 = Label(FI,text=("a2 = "),font=(10),bg="violet")
a2_E = Entry(FI,width=5,font=(10),fg="black")
cm2 = Label(FI,text=("cm "),font=(10))

a3 = Label(FI,text=("a3 = "),font=(10),bg="violet")
a3_E = Entry(FI,width=5,font=(10),fg="black")
...
#DEFINE X_E Y_E Z_E HERE
X_E = Entry(FI,width=5,font=(10))
Y_E = Entry(FI,width=5,font=(10))
Z_E = Entry(FI,width=5,font=(10))

#Button Frames
BF = LabelFrame(mygui,text="Forward & Inverse Kinematics",font=(5))
...
PV = LabelFrame(mygui,text="Position Vectors")
PV.grid(row=2,column=0)

#Position Vectors Label
X = Label(PV,text=("X = "),font=(10),bg="violet")
X_E = Entry(PV,width=5,font=(10))
cm6 = Label(PV,text=("cm"),font=(10))

Y = Label(PV,text=("Y = "),font=(10),bg="violet")
Y_E = Entry(PV,width=5,font=(10))
cm7 = Label(PV,text=("cm"),font=(10))

Z = Label(PV,text=("Z = "),font=(10),bg="violet")
