...
T1 = Label(FI,text=("T1 = "),font=(10),bg="violet",fg="black")
T1_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
deg1 = Label(FI,text=("deg"),font=(10),bg="violet",fg="black")

T2 = Label(FI,text=("T2 = "),font=(10),bg="violet",fg="black")
T2_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
deg2 = Label(FI,text=("deg"),font=(10),bg="violet",fg="black")

d3 = Label(FI,text=("d3 = "),font=(10),bg="violet",fg="black")
