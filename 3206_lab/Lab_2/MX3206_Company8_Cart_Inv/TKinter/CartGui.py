...
mygui = Tk()
mygui.title("CARTESIAN_CALCULATOR")
mygui.resizable(False,False)
mygui.configure(bg="magenta")
...
def f_k():
    ...
    PT = [[0,(270.0/180.0)*np.pi,0,a1],
         ...
         [(0.0/180.0)*np.pi,(270.0/180.0)*np.pi,0,a3+d2],
         [0,0,0,a4+d3]]
 ...
 #HTM formulae
    ...
    CARTESIAN_CALCULATOR_COMPANY10 = DHRobot([
    ...
    ], name="CARTESIAN CALCULATOR")

    #plot joints
    q1 = np.array([d1/100,d2/100,d3/100,0])
    ...
    #plot command
    CARTESIAN_CALCULATOR_COMPANY10.plot(q1,limits=[x1,x2,y1,y2,z1,z2],block=True)
...
# Create Links
    #   [robot_variable]=DHRobot([RevoluteDH(d,r,alpha,offset)])
     CARTESIAN_CALCULATOR_COMPANY10 = DHRobot([
         PrismaticDH((0/180.0)*np.pi,0,(270.0/180.0)*np.pi,a1/100,qlim=[0,0]), 
         ...
         PrismaticDH(0,0,(0/180.0)*np.pi,a4/100,qlim=[0,30/100]),
    ], name="CARTESIAN CALCULATOR")
...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables",font=(5),bg="mediumturquoise",fg="black")
