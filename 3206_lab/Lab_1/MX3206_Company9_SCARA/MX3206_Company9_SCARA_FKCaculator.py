...
mygui = Tk()
mygui.title("SCARA_RRP_CALCULATOR")
mygui.resizable(False,False)
mygui.configure(bg="skyblue")
...
FI = LabelFrame(mygui,tex="Link Lengths and Joint Variables", font=(5),bg="violet",fg="black")
FI.grid(row=0,column=0)

#Link lengths label
a1 = Label(FI,text=("a1 = "),font=(10),bg="violet",fg="black")
a1_E = Entry(FI,width=5,font=(10),bg="violet",fg="black")
cm1 = Label(FI,text=("cm "),font=(10),bg="violet",fg="black")

a2 = Label(FI,text=("a2 = "),font=(10),bg="violet",fg="black")
a2_E = Entry(FI,width=5,font=(10),bg="violet",fg="black")
cm2 = Label(FI,text=("cm "),font=(10),bg="violet",fg="black")

a3 = Label(FI,text=("a3 = "),font=(10),bg="violet",fg="black")
a3_E = Entry(FI,width=5,font=(10),bg="violet",fg="black")
cm3 = Label(FI,text=("cm "),font=(10),bg="violet",fg="black")

a4 = Label(FI,text=("a4 = "),font=(10),bg="violet",fg="black")
a4_E = Entry(FI,width=5,font=(10),bg="violet",fg="black")
cm4 = Label(FI,text=("cm "),font=(10),bg="violet",fg="black")

a5 = Label(FI,text=("a5 = "),font=(10),bg="violet",fg="black")
a5_E = Entry(FI,width=5,font=(10),bg="violet",fg="black")
cm5 = Label(FI,text=("cm "),font=(10),bg="violet",fg="black")
...
PV = LabelFrame(mygui,text="Postion Vector",font=(5))
