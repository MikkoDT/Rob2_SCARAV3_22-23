...
def f_k():
    ...
    Cylindrical_Calculator = DHRobot([
        RevoluteDH(a1,0,(0/180.0)*np.pi,(0/180.0)*np.pi,qlim=[-np.pi/2,np.pi/2]),
        PrismaticDH(0,0,(270/180.0)*np.pi,a2,qlim=[0,(30/100)]),
        PrismaticDH(0,0,(0/180.0)*np.pi,a3,qlim=[0,(30/100)])
    ], name="Cylindrical_Calculator")

    #plot joints
    q2 = np.array([T1,d2,d3,])
    ...
    #Plot command
    Cylindrical_Calculator.plot(q2,limits=[x1,x2,y1,y2,z1,z2],block=True)

#Link lengths and Joint variables
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables",font=(5),bg="#f4a896",fg="black")
FI.grid(row=0, column=0)

#Link lengths label
a1 = Label(FI,text=("a1 = "),font=(10),bg="#f4a896")
a1_E = Entry(FI,width=5,font=(10))
cm1 = Label(FI,text=("cm "),font=(10),bg="#f4a896")

a2 = Label(FI,text=("a2 = "),font=(10),bg="#f4a896")
a2_E = Entry(FI,width=5,font=(10))
cm2 = Label(FI,text=("cm "),font=(10),bg="#f4a896")

a3 = Label(FI,text=("a3 = "),font=(10),bg="#f4a896")
a3_E = Entry(FI,width=5,font=(10))
cm3 = Label(FI,text=("cm "),font=(10),bg="#f4a896")
...
T1 = Label(FI,text=(" T1 = "),font=(110),bg="#f4a896")
T1_E = Entry(FI,width=5,font=(10))
deg1 = Label(FI,text=("deg"),font=(10),bg="#f4a896")

d2 = Label(FI,text=(" d2 = "),font=(110),bg="#f4a896")
d2_E = Entry(FI,width=5,font=(10))
cm4 = Label(FI,text=("cm"),font=(10),bg="#f4a896")

d3 = Label(FI,text=(" d3 = "),font=(110),bg="#f4a896")
d3_E = Entry(FI,width=5,font=(10))
cm5 = Label(FI,text=("cm"),font=(10),bg="#f4a896")
...
#Button Frames
BF = LabelFrame(mygui,text="Forward Kinematics",font=5,bg="#f4a896")
...
PV = LabelFrame(mygui,text="Position Vectors",font=(5),bg="#f4a896")
PV.grid(row=2, column=0)

#Position Vectors label
X = Label(PV,text=("X = "),font=(10),bg="#f4a896")
X_E = Entry(PV,width=5,font=(10))
cm6 = Label(PV,text=("cm"),font=(10),bg="#f4a896")

Y = Label(PV,text=("Y = "),font=(10),bg="#f4a896")
Y_E = Entry(PV,width=5,font=(10))
cm7 = Label(PV,text=("cm"),font=(10),bg="#f4a896")

Z = Label(PV,text=("Z = "),font=(10),bg="#f4a896")
Z_E = Entry(PV,width=5,font=(10))
cm8 = Label(PV,text=("cm"),font=(10),bg="#f4a896")
