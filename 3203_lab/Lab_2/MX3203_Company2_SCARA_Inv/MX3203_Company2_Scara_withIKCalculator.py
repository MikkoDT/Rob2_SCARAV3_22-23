...
def Inverse():
    ...
    # plot joints
    ql = np.array([Th1,0,Th2,0,D3/100])
...
invr = Button(BF,text=" ↓☺Inverse",font=(10),bg="blue", fg="white", command=Inverse)
invr.grid(row=0,column=2)
