...
#Buttons
FK = Button(BF,text="ꜜForward",font=(10),bg="green",fg="white",command=f_k)
rst = Button(BF,text="Reset",font=(10),bg="red",fg="white",command=reset)
IK = Button(BF,text="ꜛInverse",font=(10),bg="green",fg="white",command=i_k)
