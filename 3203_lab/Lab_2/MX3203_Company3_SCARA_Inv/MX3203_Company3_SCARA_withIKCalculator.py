...
rst = Button(BF,text="RESET",font=(10),bg="#ffa8b5",fg="white",command=reset)
IK = Button(BF,text="↑Inverse",font=(10),bg="teal",fg="white",command=i_k)
