...
root.geometry('%dx%d+%d+%d' % (350, 400, x, y))
root.configure(background='#FFF8DC')

# image
splash_image = PhotoImage(file='cartesian.png')
Label(root, image=splash_image).pack(pady=30)

Label(root, text='Cartesian Calculator', font=('Garamond', 18), bg = '#DEB887', fg = 'black').pack(pady=14)
...
def main_window():
    ...
    #Buttons
    FK = Button(BF, text=("↑ FORWARD"), font=(14), bg="#D2B48C", fg=("black"), command=f_k)
