...
RST = Button(BF, text="Reset", font=10, bg="#45423c", fg="white", highlightbackground="#302f2a", highlightcolor="#302f2a", highlightthickness=3, activebackground="#e83535", activeforeground="white", width=7, relief="flat", command=reset)

FK.grid(row=0,column=0,padx=10,pady=17)
RST.grid(row=0,column=1,padx=10,pady=17)
...
X.grid(row=0,column=0,padx=6,pady=5)
X_E.grid(row=0,column=1,padx=6,pady=5)
cm6.grid(row=0,column=2,padx=6,pady=5)

Y.grid(row=1,column=0,padx=6,pady=5)
Y_E.grid(row=1,column=1,padx=6,pady=5)
cm7.grid(row=1,column=2,padx=6,pady=5)

Z.grid(row=2,column=0,padx=6,pady=5)
Z_E.grid(row=2,column=1,padx=6,pady=5)
cm8.grid(row=2,column=2,padx=6,pady=5)
