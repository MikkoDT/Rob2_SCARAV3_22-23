...
a1_E = Entry(FI,width=6,font=(10))
cm1 = Label(FI, text=('cm'), font=(10))

a2 = Label(FI, text=('a2 = '), font=(10))
a2_E = Entry(FI,width=6,font=(10))
...
a4_E = Entry(FI,width=6,font=(10))
cm4 = Label(FI, text=('cm'), font=(10))

a5 = Label(FI, text=('a5 = '), font=(10))
a5_E = Entry(FI,width=6,font=(10))
...
IK = Button(KF,text="↑ Inverse ↑",font=(10),bg="orange",fg="white", command=i_k)
