...
FI = LabelFrame(mygui, text="Link Lengths and Joint Variables", font = (5), labelanchor = "n", bg = "skyblue3", fg = "red")
...
# Buttons Frame
BF = LabelFrame(mygui, text = "Forward Kinematics", font = 'Arial 12 bold', labelanchor = "n", bg = "skyblue3", fg = "red")
...
PV = LabelFrame(mygui, text = "Position Vectors", font=(5), bg = "skyblue3", fg = "red")
