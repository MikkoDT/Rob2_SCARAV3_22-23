...
FI = LabelFrame(mygui, text="Link Lengths and Joint Variables", font=(5), bg="#F2CDAC", fg="black")
FI.grid(row=0, column=0)

# label of link lengths
a1 = Label(FI, text=("a1 = "), font=(10), bg="#F2CDAC", fg="black")
a1_E = Entry(FI, width=5, font=(10))
cm1 = Label(FI, text=("cm"), font=(10), bg="#F2CDAC", fg="black")

a2 = Label(FI, text=("a2 = "), font=(10), bg="#F2CDAC", fg="black")
a2_E = Entry(FI, width=5, font=(10))
cm2 = Label(FI, text=("cm"), font=(10), bg="#F2CDAC", fg="black")

a3 = Label(FI, text=("a3 = "), font=(10), bg="#F2CDAC", fg="black")
a3_E = Entry(FI, width=5, font=(10))
cm3 = Label(FI, text=("cm"), font=(10), bg="#F2CDAC", fg="black")
...
T1 = Label(FI, text=("T1 = "), font=(10), bg="#F2CDAC", fg="black")
T1_E = Entry(FI, width=5, font=(10))
deg1 = Label(FI, text=("deg"), font=(10), bg="#F2CDAC", fg="black")

T2 = Label(FI, text=("T2 = "), font=(10), bg="#F2CDAC", fg="black")
T2_E = Entry(FI, width=5, font=(10))
deg2 = Label(FI, text=("deg"), font=(10), bg="#F2CDAC", fg="black")

d3 = Label(FI, text=("d3 = "), font=(10), bg="#F2CDAC", fg="black")
d3_E = Entry(FI, width=5, font=(10))
cm4 = Label(FI, text=("cm"), font=(10), bg="#F2CDAC", fg="black")
...
# Buttons Frame
BF = LabelFrame(mygui, text="Forward & Inverse Kinematics", font=(5), bg="#F2CDAC")
...
PV = LabelFrame(mygui, text="Position Vectors", font=(5), bg="#F2CDAC")
PV.grid(row=2, column=0)

# Position Vectors label
X = Label(PV, text=("X = "), font=(10), bg="#F2CDAC")
X_E = Entry(PV, width=5, font=(10))
cm6 = Label(PV, text=("cm"), font=(10), bg="#F2CDAC")

Y = Label(PV, text=("Y = "), font=(10), bg="#F2CDAC")
Y_E = Entry(PV, width=5, font=(10))
cm7 = Label(PV, text=("cm"), font=(10), bg="#F2CDAC")

Z = Label(PV, text=("Z = "), font=(10), bg="#F2CDAC")
Z_E = Entry(PV, width=5, font=(10))
cm8 = Label(PV, text=("cm"), font=(10), bg="#F2CDAC")
