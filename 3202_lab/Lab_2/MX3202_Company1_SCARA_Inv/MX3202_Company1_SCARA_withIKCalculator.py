...
def f_k():
        ...
        SCARA_RRP = DHRobot([
                ...
                RevoluteDH(a3, 0, (180.0/180.0)*np.pi, (0/180.0)*np.pi, qlim=[-np.pi/2,np.pi/2]),
                PrismaticDH(0, a4, 0, 0, qlim=[0,0]),
                PrismaticDH(0, 0, 0, a5, qlim=[0,30/100]),
        ], name="SCARA RRP")
        ...
        #Plot command
        SCARA_RRP.plot(q1, limits=[x1,x2,y1,y2,z1,z2],block=True)
...
def i_k() :
        ...
        SCARA_RRP = DHRobot([
                ...
                RevoluteDH(a3/100, 0, (180.0/180.0)*np.pi, (0/180.0)*np.pi, qlim=[-np.pi/2,np.pi/2]),
                PrismaticDH(0, a4/100, 0, 0, qlim=[0,0]),
                PrismaticDH(0, 0, 0, a5/100, qlim=[0,30/100]),
        ], name="SCARA RRP")
...
#display image
img = PhotoImage(file = "MX3202_Company1_SCARA_Image.png")
