...
def i_k():
    ...
    SCARAV3 = DHRobot([
    RevoluteDH(a1/100,0,(0/180.0)*np.pi,(0/180.0)*np.pi,qlim=[-np.pi/2,np.pi/2]),
    PrismaticDH(0,a2/100,0,0,qlim=[0,0]),
    RevoluteDH(a3/100,0,(180/180.0)*np.pi,(0/180.0)*np.pi,qlim=[-np.pi/2,np.pi/2]),
...
fdkm = Label(FI,text=("Kinematics Calculation"),font=(10), bg = "gray13", fg="white")
...
FK = Button(FI, text="↓FORWARD",font=(10), bg="mediumseagreen", width=(15), fg="white", highlightthickness=(1), command=f_k) 
FK.config(highlightbackground= "gray13", highlightcolor="white")
IK = Button(FI,text="↑INVERSE",font=(10), width=(15), fg="white", highlightthickness=(1), bg="dodgerblue1", command=i_k)
IK.config(highlightbackground= "gray13", highlightcolor="white")
...
X.grid(row=16,column=0)
X_E.grid(row=16,column=1)
cm6.grid(row=16,column=2)

Y.grid(row=17,column=0)
Y_E.grid(row=17,column=1)
cm7.grid(row=17,column=2)

Z.grid(row=18,column=0)
Z_E.grid(row=18,column=1)
cm8.grid(row=18,column=2)
