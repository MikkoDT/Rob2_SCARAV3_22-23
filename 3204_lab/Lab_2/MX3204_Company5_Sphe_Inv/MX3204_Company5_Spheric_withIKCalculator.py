...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables", font=(5),bg="#52B2BF")
FI.grid(row=0, column=0)

#link lengths label 
a1 = Label(FI,text=("a1 = "),font=(10),bg="#A89A8F")
a1_E = Entry(FI,width=5,font=(10))
cm1 = Label(FI,text=("cm "),font=(10),bg="#A89A8F")

a2 = Label(FI,text=("a2 = "),font=(10),bg="#A89A8F")
a2_E = Entry(FI,width=5,font=(10))
cm2 = Label(FI,text=("cm "),font=(10),bg="#A89A8F")

a3 = Label(FI,text=("a3 = "),font=(10),bg="#A89A8F")
a3_E = Entry(FI,width=5,font=(10))
cm3 = Label(FI,text=("cm "),font=(10),bg="#A89A8F")
...
T1 = Label(FI,text=("T1 = "),font=(10),bg =("#A89A8F"))
T1_E = Entry(FI,width=5,font=(10))
deg1 = Label(FI,text=("deg "),font=(10),bg =("#A89A8F"))

T2 = Label(FI,text=("T2 = "),font=(10),bg =("#A89A8F"))
T2_E = Entry(FI,width=5,font=(10))
deg2 = Label(FI,text=("deg "),font=(10),bg =("#A89A8F"))

d3 = Label(FI,text=("d3 = "),font=(10),bg =("#A89A8F"))
d3_E = Entry(FI,width=5,font=(10))
cm4 = Label(FI,text=("cm "),font=(10),bg =("#A89A8F"))
...
#button frame
BF = LabelFrame(mygui,text="Forward Kinematics", font=(5),bg =("#52B2BF"))
BF.grid(row=1, column=0)

#buttons
FK = Button(BF, text="Forward",font=(10),bg="#FCBACB",fg="black",command=f_k) #bg is for bacground color, fg is for font color
rst = Button(BF, text="Reset",font=(10),bg="#BC8F8F",fg="black",command=reset)
IK = Button(BF, text="Inverse",font=(10),bg="#FCBACB",fg="black",command=i_k)
...
PV = LabelFrame(mygui,text="Position Vectors", font=(5),bg =("#52B2BF"))
PV.grid(row=2, column=0)

#position vector label
X = Label(PV,text=("X = "),font=(10),bg="#A89A8F")
X_E = Entry(PV,width=5,font=(10))
cm6 = Label(PV,text=("cm "),font=(10),bg="#A89A8F")

Y = Label(PV,text=("Y = "),font=(10),bg="#A89A8F")
Y_E = Entry(PV,width=5,font=(10))
cm7 = Label(PV,text=("cm "),font=(10),bg="#A89A8F")

Z = Label(PV,text=("Z = "),font=(10),bg="#A89A8F")
Z_E = Entry(PV,width=5,font=(10))
cm8 = Label(PV,text=("cm "),font=(10),bg="#A89A8F")
