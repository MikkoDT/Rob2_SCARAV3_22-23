...
FI = LabelFrame(mygui, text="Link Lengths and Joint Variables", font=(5), bg="cyan", fg="black")
FI.grid(row=0, column=0)

# label of link lengths
a1 = Label(FI, text=("a1 = "), font=(10), bg="#6495ED", fg="black")
a1_E = Entry(FI, width=5, font=(10))
cm1 = Label(FI, text=("cm"), font=(10), bg="#6495ED", fg="black")

a2 = Label(FI, text=("a2 = "), font=(10), bg="#6495ED", fg="black")
a2_E = Entry(FI, width=5, font=(10))
cm2 = Label(FI, text=("cm"), font=(10), bg="#6495ED", fg="black")

a3 = Label(FI, text=("a3 = "), font=(10), bg="#6495ED", fg="black")
a3_E = Entry(FI, width=5, font=(10))
cm3 = Label(FI, text=("cm"), font=(10), bg="#6495ED", fg="black")
...
T1 = Label(FI, text=("T1 = "), font=(10), bg="#6495ED", fg="black")
T1_E = Entry(FI, width=5, font=(10))
deg1 = Label(FI, text=("deg"), font=(10), bg="#6495ED", fg="black")

T2 = Label(FI, text=("T2 = "), font=(10), bg="#6495ED", fg="black")
T2_E = Entry(FI, width=5, font=(10))
deg2 = Label(FI, text=("deg"), font=(10), bg="#6495ED", fg="black")

d3 = Label(FI, text=("d3 = "), font=(10), bg="#6495ED", fg="black")
d3_E = Entry(FI, width=5, font=(10))
cm4 = Label(FI, text=("cm"), font=(10), bg="#6495ED", fg="black")
...
# Buttons Frame
BF = LabelFrame(mygui, text="Forward & Inverse Kinematics", font=(5), bg="cyan")
BF.grid(row=1, column=0)

# Buttons 
FK = Button(BF, text="Forward",font=(10), bg="#0000FF", fg="white", command=f_k)
rst = Button(BF, text="Reset",font=(10), bg="#800080", fg="white", command=reset)
...
X = Label(PV, text=("X = "), font=(10), bg="#6495ED")
X_E = Entry(PV, width=5, font=(10))
cm6 = Label(PV, text=("cm"), font=(10), bg="#6495ED")

Y = Label(PV, text=("Y = "), font=(10), bg="#6495ED")
Y_E = Entry(PV, width=5, font=(10))
cm7 = Label(PV, text=("cm"), font=(10), bg="#6495ED")

Z = Label(PV, text=("Z = "), font=(10), bg="#6495ED")
Z_E = Entry(PV, width=5, font=(10))
cm8 = Label(PV, text=("cm"), font=(10), bg="#6495ED")
...
img = PhotoImage(file ="MX3204_Company4_Spherical_FKCalculator.png")
