...
def f_k():
    #Forward Kinematic using Graphical Method
    # link lengths in cm
...
def i_k():
    #Inverse Kinematic using Graphical Method
    # link lengths in cm
    a1 = float(a1_E.get())
    a2 = float(a2_E.get())
    a3 = float(a3_E.get())
    ...
    SCARA = DHRobot([
        ...
        PrismaticDH(0,0,(0.0/180.0)*np.pi,a5/100,qlim=[0,30/100])
          ],name='SCARA_V3')
...
# Link lengths label
a1 = Label(FI,text=("a1= "),font=(10),bg="#B98D74")
a1_E = Entry(FI,width=10,font=(10))
cm1 = Label(FI,text=("cm"),font=(10),bg="#DE9975")

a2 = Label(FI,text=("a2= "),font=(10),bg="#B98D74")
a2_E = Entry(FI,width=10,font=(10))
cm2 = Label(FI,text=("cm"),font=(10),bg="#DE9975")

a3 = Label(FI,text=("a3= "),font=(10),bg="#B98D74")
a3_E = Entry(FI,width=10,font=(10))
cm3 = Label(FI,text=("cm"),font=(10),bg="#DE9975")

a4 = Label(FI,text=("a4= "),font=(10),bg="#B98D74")
a4_E = Entry(FI,width=10,font=(10))
cm4 = Label(FI,text=("cm"),font=(10),bg="#DE9975")

a5 = Label(FI,text=("a5= "),font=(10),bg="#B98D74")
a5_E = Entry(FI,width=10,font=(10))
cm5 = Label(FI,text=("cm"),font=(10),bg="#DE9975")
...
T1 = Label(FI,text=("T1="),font=(10),bg="#B98D74")
T1_E = Entry(FI,width=5, font=(10))
deg1 = Label(FI,text=("deg"), font=(10),bg="#DE9975")

T2 = Label(FI,text=("T2="),font=(10),bg="#B98D74")
T2_E = Entry(FI,width=5, font=(10))
deg2 = Label(FI,text=("deg"), font=(10),bg="#DE9975")

d3 = Label(FI,text=("d3= "),font=(10),bg="#B98D74")
d3_E = Entry(FI,width=5, font=(10))
cm6 = Label(FI,text=("cm"), font=(10),bg="#DE9975")
...
#button frame
BF = LabelFrame(mygui,text="Forward & Inverse Kinematics",font=(5),bg="gray")
BF.grid(row=1,column=0)

# Buttons
FK = Button(BF,text="↓ Forward",font=(10),bg="#222021",fg="white",command=f_k) #bg is for background color and fg is for font color
rst = Button(BF,text="Reset",font=(10),bg="#363636",fg="white",command=reset)
IK = Button(BF,text="↑ Inverse",font=(10),bg="#2C2C2C",fg="white",command=i_k)
...
X = Label(PV,text=("X="),font=(10),bg="#B98D74")
X_E = Entry(PV,width=5,font=(10))
cm7 = Label(PV,text=("cm"),font=(10),bg="#DE9975")

Y = Label(PV,text=("Y= "),font=(10),bg="#B98D74")
Y_E = Entry(PV,width=5,font=(10))
cm8 = Label(PV,text=("cm"),font=(10),bg="#DE9975")

Z = Label(PV,text=("Z="),font=(10),bg="#B98D74")
Z_E = Entry(PV,width=5,font=(10))
cm9 = Label(PV,text=("cm"),font=(10),bg="#DE9975")
