...
FI = LabelFrame(mygui,text="  Link Lengths and Joint Variables",font=(5), bg="#E29381")
FI.grid(row=0,column=0)

#Link lengths label
a1 = Label(FI,text=("a1 = "), font=(10),bg="#D9DDDC")
a1_E = Entry(FI,width=5,font=(10),bg="#E8C3A2")
cm1 = Label(FI,text=("cm "), font=(10),bg="#D9DDDC")

a2 = Label(FI,text=("a2 = "), font=(10),bg="#D9DDDC")
a2_E = Entry(FI,width=5,font=(10),bg="#E8C3A2")
cm2 = Label(FI,text=("cm "), font=(10),bg="#D9DDDC")

a3 = Label(FI,text=("a3 = "), font=(10),bg="#D9DDDC")
a3_E = Entry(FI,width=5,font=(10),bg="#E8C3A2")
cm3 = Label(FI,text=("cm "), font=(10),bg="#D9DDDC")
...
T1 = Label(FI,text=("T1 = "), font=(10),bg="#D9DDDC")
T1_E = Entry(FI,width=5,font=(10),bg="#E8C3A2")
deg1 = Label(FI,text=("deg "), font=(10),bg="#D9DDDC")

T2 = Label(FI,text=("T2 = "), font=(10),bg="#D9DDDC")
T2_E = Entry(FI,width=5,font=(10),bg="#E8C3A2")
deg2 = Label(FI,text=("deg "), font=(10),bg="#D9DDDC")

T3 = Label(FI,text=("T3 = "), font=(10),bg="#D9DDDC")
T3_E = Entry(FI,width=5,font=(10),bg="#E8C3A2")
deg3 = Label(FI,text=("deg "), font=(10),bg="#D9DDDC")
...
# Button Frame
BF = LabelFrame(mygui, text="  Forward and Inverse Kinematics", font=(5),bg="#E29381")
BF.grid(row=1,column=0)

# Buttons
FK = Button(BF,text="↓Forward",font=(5), bg="#BCC0C9", fg="black",command=f_k)
rst = Button(BF,text="Reset",font=(5), bg="#959899", fg="black", command=reset)
IK = Button(BF,text="↑Inverse",font=(5), bg="#BCC0C9", fg="black", command=i_k)
...
PV = LabelFrame(mygui, text="Position Vectors", font=(5),bg="#E29381")
PV.grid(row=2,column=0)

#Position Vector Labels
X = Label(PV,text=("X = "), font=(10),bg="#D9DDDC")
X_E = Entry(PV,width=5,font=(10),bg="#E8C3A2")
cm1 = Label(PV,text=("cm "), font=(10),bg="#D9DDDC")

Y = Label(PV,text=("Y = "), font=(10),bg="#D9DDDC")
Y_E = Entry(PV,width=5,font=(10),bg="#E8C3A2")
cm2 = Label(PV,text=("cm "), font=(10),bg="#D9DDDC")

Z = Label(PV,text=("Z = "), font=(10),bg="#D9DDDC")
Z_E = Entry(PV,width=5,font=(10),bg="#E8C3A2")
cm3 = Label(PV,text=("cm "), font=(10),bg="#D9DDDC")
