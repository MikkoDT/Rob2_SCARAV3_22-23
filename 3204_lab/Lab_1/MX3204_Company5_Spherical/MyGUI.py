...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables", font=(5),bg="red")
FI.grid(row=0, column=0)

#link lengths label 
a1 = Label(FI,text=("a1 = "),font=(10),bg="green")
a1_E = Entry(FI,width=5,font=(10))
cm1 = Label(FI,text=("cm "),font=(10),bg="green")

a2 = Label(FI,text=("a2 = "),font=(10),bg="green")
a2_E = Entry(FI,width=5,font=(10))
cm2 = Label(FI,text=("cm "),font=(10),bg="green")

a3 = Label(FI,text=("a3 = "),font=(10),bg="green")
a3_E = Entry(FI,width=5,font=(10))
cm3 = Label(FI,text=("cm "),font=(10),bg="green")
...
#buttons
FK = Button(BF, text="Forward",font=(10),bg="blue",fg="black",command=f_k) #bg is for bacground color, fg is for font color
rst = Button(BF, text="Reset",font=(10),bg="purple",fg="black",command=reset)
