...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables",font=(5), bg="tan")
FI.grid(row=0,column=0)

#Link lengths label
a1 = Label(FI,text=("a1 = "), font=(10),bg="light gray")
a1_E = Entry(FI,width=5,font=(10),bg="white")
cm1 = Label(FI,text=("cm "), font=(10),bg="light gray")

a2 = Label(FI,text=("a2 = "), font=(10),bg="light gray")
a2_E = Entry(FI,width=5,font=(10),bg="white")
cm2 = Label(FI,text=("cm "), font=(10),bg="light gray")

a3 = Label(FI,text=("a3 = "), font=(10),bg="light gray")
a3_E = Entry(FI,width=5,font=(10),bg="white")
cm3 = Label(FI,text=("cm "), font=(10),bg="light gray")
...
T1 = Label(FI,text=("T1 = "), font=(10),bg="silver")
T1_E = Entry(FI,width=5,font=(10),bg="white")
deg1 = Label(FI,text=("deg "), font=(10),bg="silver")

T2 = Label(FI,text=("T2 = "), font=(10),bg="silver")
T2_E = Entry(FI,width=5,font=(10),bg="white")
deg2 = Label(FI,text=("deg "), font=(10),bg="silver")

T3 = Label(FI,text=("T3 = "), font=(10),bg="silver")
T3_E = Entry(FI,width=5,font=(10),bg="white")
deg3 = Label(FI,text=("deg "), font=(10),bg="silver")
...
# Button Frame
BF = LabelFrame(mygui, text="Forward Kinematics", font=(5),bg="tan")
BF.grid(row=1,column=0)

# Buttons
FK = Button(BF,text="Forward",font=(5), bg="teal", fg="black",command=f_k)
rst = Button(BF,text="Reset",font=(5), bg="light blue", fg="black", command=reset)

FK.grid(row=0,column=0)
rst.grid(row=0,column=1)

# Position Vector Frame
PV = LabelFrame(mygui, text="Position Vectors", font=(5),bg="tan")
PV.grid(row=2,column=0)

#Position Vector Labels
X = Label(PV,text=("X = "), font=(10),bg="light gray")
X_E = Entry(PV,width=5,font=(10),bg="white")
cm1 = Label(PV,text=("cm "), font=(10),bg="light gray")

Y = Label(PV,text=("Y = "), font=(10),bg="light gray")
Y_E = Entry(PV,width=5,font=(10),bg="white")
cm2 = Label(PV,text=("cm "), font=(10),bg="light gray")

Z = Label(PV,text=("Z = "), font=(10),bg="light gray")
Z_E = Entry(PV,width=5,font=(10),bg="white")
cm3 = Label(PV,text=("cm "), font=(10),bg="light gray")
