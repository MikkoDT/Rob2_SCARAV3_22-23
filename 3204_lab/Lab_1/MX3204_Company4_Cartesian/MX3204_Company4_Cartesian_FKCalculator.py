...
def f_k():
    ...
    # plot command
    CARTESIAN_04.plot(q1,limits=[x1,x2,y1,y2,z1,z2],block=True)
...
# Button Frame
BF = LabelFrame(mygui, text="Forward Kinematics", font=(5),bg="light blue")
...
# display image
img = PhotoImage(file='cartesian04.png')
