...
def f_k():
    ...
    Cylindrical = DHRobot([
          RevoluteDH(a1,0,(0.0/180.0)*np.pi,T1,qlim=[-np.pi/2,np.pi/2]),
...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables", font=(5),bg="yellowgreen")
...
T1 = Label(FI,text=("T1 = "),font=(10),bg="green")
T1_E = Entry(FI,width=5,font=(10))
deg1 = Label(FI,text=("cm "),font=(10),bg="green")

d2 = Label(FI,text=("d2 = "),font=(10),bg="green")
d2_E = Entry(FI,width=5,font=(10))
cm4 = Label(FI,text=("cm "),font=(10),bg="green")

d3 = Label(FI,text=("d3 = "),font=(10),bg="green")
d3_E = Entry(FI,width=5,font=(10))
cm5 = Label(FI,text=("cm "),font=(10),bg="green")
