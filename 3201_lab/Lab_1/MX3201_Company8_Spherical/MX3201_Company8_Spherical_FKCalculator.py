...
def f_k():
    ...
    # Plot Command
    SphericalManipulator.plot(q1,limits=[x1,x2,y1,y2,z1,z2],block=True)
...
# Button Frame
BF = LabelFrame(mygui,text="  Forward Kinematics  ",font=(5),fg="white",bg="gray")
