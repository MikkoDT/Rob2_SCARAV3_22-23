#MX3201_Company8_Articulated_withIKCalculator.py
...
def f_k():
    ...
    #[robot_variable]=DHRobot([RevoluteDH(d,r,alpha,offset)])
        MX3201_Company8_Articulated_withIKCalculator = DHRobot([
        ...
        #Plot Command
        MX3201_Company8_Articulated_withIKCalculator.plot(q1,limits=[x1,x2,y1,y2,z1,z2],block=True)
