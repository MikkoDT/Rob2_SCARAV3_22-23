...
# Window and Title
MX3201_Company8_SCARA_withIKCalculator = Tk()
MX3201_Company8_SCARA_withIKCalculator.title("SCARA Calculator")
MX3201_Company8_SCARA_withIKCalculator.resizable(False, False)
MX3201_Company8_SCARA_withIKCalculator.configure(bg="wheat")
...
FI = LabelFrame(MX3201_Company8_SCARA_withIKCalculator,text="Link Lengths and Joint Variables",font=(S),bg="wheat")
...
# Button Frame
BF = LabelFrame(MX3201_Company8_SCARA_withIKCalculator,text="Forward Kinematics",font=(5),bg="cyan",fg="black")
...
IK = Button(BF,text="↑ Inverse",font=(10),bg="pink",fg="black",command=i_k)
...
PV = LabelFrame(MX3201_Company8_SCARA_withIKCalculator,text="Position Vectors",font=(5),bg="cyan",fg="black")
...
PI = Label(MX3201_Company8_SCARA_withIKCalculator,image=img)
PI.grid(row=3,column=0)

MX3201_Company8_SCARA_withIKCalculator.mainloop()
